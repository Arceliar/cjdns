 ...
 */
#ifndef LinkStateRandomNodeCollector_H
#define LinkStateRandomNodeCollector_H
 ...
 */
static inline void LinkStateRandomNodeCollector_addNode(struct NodeHeader* header,
                                                  struct Node* body,
                                                  ...
                                                  bool replaceOnMatch)
{
    ...
    if (nodeDistance < collector->thisNodeDistance) {
        ...
        uint64_t value = 0;
        #define LinkStateRandomNodeCollector_getValue(value, header, body, nodeDistance)         \
            if (value == 0) {                                                                    \
        ...
        for (i = 0; i < collector->capacity; i++) {
            ...
            LinkStateRandomNodeCollector_getValue(value, header, body, nodeDistance);
        ...
        #undef LinkStateRandomNodeCollector_getValue
    }
}
